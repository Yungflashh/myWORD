...
let attemptsContainer = document.getElementById("attempts") as HTMLDivElement;
let wordguess: string[] = ["CRYPT"];
...
function createInputFields(word: string) {
...
function displayCurrentGuess(inputs: HTMLInputElement[]) {
